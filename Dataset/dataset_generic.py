...
class Generic_WSI_Classification_Dataset(Dataset):
	...
	def summarize(self):
		...
		for i in range(self.num_classes):
			print('Number of samples registered in class %d: %d' % (i, self.patient_cls_ids[i].shape[0]))
			print('Number of samples registered in class %d: %d' % (i, self.slide_cls_ids[i].shape[0]))
